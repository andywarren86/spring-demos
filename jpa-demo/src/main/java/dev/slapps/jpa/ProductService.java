...
public class ProductService {
   ...
   */
  public Product insertProductViaRepo(final String name, final String description, final Double price) {
  ...
  public Product insertProductViaSession(final String name, final String description, final Double price) {
